class Admin::NineteenForm
  include ActiveModel::Model

  attr_accessor :nineteen 
  delegate :persisted?, :save, to: :nineteen
  
  def initialize(nineteen = nil)
    @nineteen = nineteen
