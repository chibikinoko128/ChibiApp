class Customer::AccountForm
  ...
  private
  def customer_params
    @params.require(:customer).permit(:family_name, :given_name, :family_name_kana, :given_name_kana, :birthday, :gender, :nickname, :sponsor1, :email)
    #@params.permit(customer: [:family_name, :given_name, :family_name_kana, :given_name_kana, :birthday, :gender, :nickname, :sponsor1])
  end

  def home_address_params
    @params.require(:home_address).permit(:home_address, :postal_code, :prefecture, :city, :address1, :address2)
  ...
  def phone_params(record_name)
    ...
    #@params.permit(phones: [ :number, :primary])
  end
end
