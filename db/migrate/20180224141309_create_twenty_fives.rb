class CreateTwentyFives < ActiveRecord::Migration[5.1]
  def change
    create_table :twenty_fives do |t|
      t.references :customer, null: false               # 顧客への外部キー
      t.integer :year, null: false, default: 2025       # 年
    ...
    add_index :twenty_fives, :m_1
    add_index :twenty_fives, :m_2
    add_index :twenty_fives, :m_3
    add_index :twenty_fives, :c_1
    add_index :twenty_fives, :m_4
    add_index :twenty_fives, :m_5
    add_index :twenty_fives, :m_6
    add_index :twenty_fives, :c_2
    add_index :twenty_fives, :m_7
    add_index :twenty_fives, :m_8
    add_index :twenty_fives, :m_9
    add_index :twenty_fives, :c_3
    add_index :twenty_fives, :m_10
    add_index :twenty_fives, :m_11
    add_index :twenty_fives, :m_12
    add_index :twenty_fives, :c_4
    add_index :twenty_fives, :pt_special_1
    add_index :twenty_fives, :pt_special_2
    add_index :twenty_fives, :pt_special_3
    add_index :twenty_fives, :pt_special_4
    add_index :twenty_fives, :pt_special_5
    add_index :twenty_fives, :pt_special_6
    add_index :twenty_fives, :pt_special_7
    add_index :twenty_fives, :pt_special_8
    add_index :twenty_fives, :pt_special_9
    add_index :twenty_fives, :pt_special_10
    add_index :twenty_fives, :pt_special_11
    add_index :twenty_fives, :pt_special_12
  end
end
