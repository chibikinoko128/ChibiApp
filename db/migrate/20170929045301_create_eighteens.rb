class CreateEighteens < ActiveRecord::Migration[5.1]
  def change
    create_table :eighteens do |t|
      t.references :customer, null: false               # 顧客への外部キー
      #t.integer :customer_id, null: false
      t.integer :year, null: false, default: 2018       # 年
    ...
    add_index :eighteens, :m_1
    add_index :eighteens, :m_2
    add_index :eighteens, :m_3
    add_index :eighteens, :c_1
    add_index :eighteens, :m_4
    add_index :eighteens, :m_5
    add_index :eighteens, :m_6
    add_index :eighteens, :c_2
    add_index :eighteens, :m_7
    add_index :eighteens, :m_8
    add_index :eighteens, :m_9
    add_index :eighteens, :c_3
    add_index :eighteens, :m_10
    add_index :eighteens, :m_11
    add_index :eighteens, :m_12
    add_index :eighteens, :c_4
    add_index :eighteens, :pt_special_1
    add_index :eighteens, :pt_special_2
    add_index :eighteens, :pt_special_3
    add_index :eighteens, :pt_special_4
    add_index :eighteens, :pt_special_5
    add_index :eighteens, :pt_special_6
    add_index :eighteens, :pt_special_7
    add_index :eighteens, :pt_special_8
    add_index :eighteens, :pt_special_9
    add_index :eighteens, :pt_special_10
    add_index :eighteens, :pt_special_11
    add_index :eighteens, :pt_special_12
  end
end
