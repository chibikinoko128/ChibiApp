class CreateTwentyTwos < ActiveRecord::Migration[5.1]
  def change
    ...
    add_index :twenty_twos, :c_1
    add_index :twenty_twos, :m_4
    add_index :twenty_twos, :m_5
    add_index :twenty_twos, :m_6
    add_index :twenty_twos, :c_2
    add_index :twenty_twos, :m_7
    add_index :twenty_twos, :m_8
    add_index :twenty_twos, :m_9
    add_index :twenty_twos, :c_3
    add_index :twenty_twos, :m_10
    add_index :twenty_twos, :m_11
    add_index :twenty_twos, :m_12
    add_index :twenty_twos, :c_4
    add_index :twenty_twos, :pt_special_1
    add_index :twenty_twos, :pt_special_2
    add_index :twenty_twos, :pt_special_3
    add_index :twenty_twos, :pt_special_4
    add_index :twenty_twos, :pt_special_5
    add_index :twenty_twos, :pt_special_6
    add_index :twenty_twos, :pt_special_7
    add_index :twenty_twos, :pt_special_8
    add_index :twenty_twos, :pt_special_9
    add_index :twenty_twos, :pt_special_10
    add_index :twenty_twos, :pt_special_11
    add_index :twenty_twos, :pt_special_12
  end
end
