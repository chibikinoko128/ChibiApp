class CreateTwentyFours < ActiveRecord::Migration[5.1]
  def change
    create_table :twenty_fours do |t|
      ...
      t.integer :year, null: false, default: 2024      # 年
    ...
    add_index :twenty_fours, :m_1
    add_index :twenty_fours, :m_2
    add_index :twenty_fours, :m_3
    add_index :twenty_fours, :c_1
    add_index :twenty_fours, :m_4
    add_index :twenty_fours, :m_5
    add_index :twenty_fours, :m_6
    add_index :twenty_fours, :c_2
    add_index :twenty_fours, :m_7
    add_index :twenty_fours, :m_8
    add_index :twenty_fours, :m_9
    add_index :twenty_fours, :c_3
    add_index :twenty_fours, :m_10
    add_index :twenty_fours, :m_11
    add_index :twenty_fours, :m_12
    add_index :twenty_fours, :c_4
    add_index :twenty_fours, :pt_special_1
    add_index :twenty_fours, :pt_special_2
    add_index :twenty_fours, :pt_special_3
    add_index :twenty_fours, :pt_special_4
    add_index :twenty_fours, :pt_special_5
    add_index :twenty_fours, :pt_special_6
    add_index :twenty_fours, :pt_special_7
    add_index :twenty_fours, :pt_special_8
    add_index :twenty_fours, :pt_special_9
    add_index :twenty_fours, :pt_special_10
    add_index :twenty_fours, :pt_special_11
    add_index :twenty_fours, :pt_special_12
  end
end
